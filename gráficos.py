...
dados = pd.read_csv('DadosSemBarra.txt', delimiter='\t', names=nomes_colunas)
...
#plt.plot(dadosOriginais['tempo'], dadosSuavizados['accX'], color='red', label='Eixo X');
#plt.plot(dadosOriginais['tempo'], dadosSuavizados['accY'], color='blue', label='Eixo Y');
#plt.plot(dadosOriginais['tempo'], dadosSuavizados['accZ'], color='green', label='Eixo Z');
plt.plot(tempo, dadosSuavizados['accRes'], color='purple', label = 'Eixo Resultante');
